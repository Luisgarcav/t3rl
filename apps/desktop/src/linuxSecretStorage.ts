...
function getGnomeKeyringRemediationMessage(): string {
  return "t3RL could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart t3RL.";
}

function getKWalletRemediationMessage(): string {
  return "t3RL could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart t3RL.";
}
