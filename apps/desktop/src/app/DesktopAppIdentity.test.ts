...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/t3RL.app/Contents/Resources/app.asar",
  isPackaged: true,
  resourcesPath: "/Applications/t3RL.app/Contents/Resources",
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["t3RL (Alpha)"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "t3RL (Alpha)");
