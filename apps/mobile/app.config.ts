    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active t3RL agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow t3RL to connect to t3RL servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow t3RL to access your camera so you can scan pairing QR codes.",
