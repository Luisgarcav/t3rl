...
export default function Sidebar() {
  ...
  // This button has one predictable action: create in the active project's
  // context, falling back to the first project. Choosing a different project
  // remains available through "New thread in..." in the command palette.
