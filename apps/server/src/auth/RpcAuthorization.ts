...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.rlListArtifacts]: AuthOrchestrationReadScope,
  [WS_METHODS.rlSubscribeRun]: AuthOrchestrationReadScope,
  [WS_METHODS.rlStartRun]: AuthOrchestrationOperateScope,
  [WS_METHODS.rlResumeRun]: AuthOrchestrationOperateScope,
  [WS_METHODS.rlWarmStartRun]: AuthOrchestrationOperateScope,
  [WS_METHODS.rlCancelRun]: AuthOrchestrationOperateScope,
  [WS_METHODS.rlCreateStudy]: AuthOrchestrationOperateScope,
  [WS_METHODS.rlGetStudy]: AuthOrchestrationReadScope,
  [WS_METHODS.rlCompareStudy]: AuthOrchestrationReadScope,
  [WS_METHODS.rlValidateExperiment]: AuthOrchestrationReadScope,
  [WS_METHODS.rlExportEvidence]: AuthOrchestrationOperateScope,
  [WS_METHODS.rlRecordResearch]: AuthOrchestrationOperateScope,
  [WS_METHODS.rlGetResearchRecord]: AuthOrchestrationReadScope,
