...
<html lang="en">
  <head>
    ...
    <title>t3RL Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up t3RL Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
