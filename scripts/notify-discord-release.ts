  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new t3RL prerelease is available for nightly testers."
          : "A new t3RL latest release is available.",
...
).pipe(Command.withDescription("Post a t3RL release announcement to Discord."));
